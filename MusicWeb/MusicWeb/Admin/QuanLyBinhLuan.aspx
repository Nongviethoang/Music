...
<asp:Content ID="Content5" ContentPlaceHolderID="ListDanhSach" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="maCamNhan" DataSourceID="SqlDataSource1">
        <Columns>
            <asp:BoundField DataField="maCamNhan" HeaderText="maCamNhan" InsertVisible="False" ReadOnly="True" SortExpression="maCamNhan" />
            ...
            <asp:BoundField DataField="maBaiHat" HeaderText="maBaiHat" SortExpression="maBaiHat" />
            <asp:BoundField DataField="maThanhVien" HeaderText="maThanhVien" SortExpression="maThanhVien" />
